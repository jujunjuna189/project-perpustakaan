    ...
    <div class="page">
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-menu-columns">
                                    <div class="dropdown-menu-column">
                                        <a class="dropdown-item ps-2" href="{{ route('anggota') }}">
                                            <span class="ps-4">Data Anggota</span>
                                        </a>
                                        <a class="dropdown-item ps-2" href="{{ route('buku') }}">
                                            <span class="ps-4">Data Buku</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <a class="nav-link" href="#">
                                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trolley" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        <path d="M11 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"></path>
                                        <path d="M6 16l3 2"></path>
                                        <path d="M12 17l8 -12"></path>
                                        <path d="M17 10l2 1"></path>
                                        <path d="M9.592 4.695l3.306 2.104a1.3 1.3 0 0 1 .396 1.8l-3.094 4.811a1.3 1.3 0 0 1 -1.792 .394l-3.306 -2.104a1.3 1.3 0 0 1 -.396 -1.8l3.094 -4.81a1.3 1.3 0 0 1 1.792 -.394z"></path>
                                    </svg>
                                </span>
                                <span class="nav-link-title">
                                    Peminjaman
        ...
        <header class="navbar navbar-expand-md navbar-light d-none d-lg-flex d-print-none">
            <div class="container-xl">
                @if(session('user')->hak_akses == 2)
                <a href="{{ route('dashboard') }}" class="h2 text-dark">Perpustakaan</a>
                @endif
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-menu">
                    <span class="navbar-toggler-icon">Perpustakaan</span>
                </button>
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ms-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="./docs/index.html" class="link-secondary">Ujikom 2023.</a></li>
                            </ul>
                        </div>
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    Copyright &copy; Ujun Junaedi.
                                </li>
                            </ul>
                        </div>
                    </div>

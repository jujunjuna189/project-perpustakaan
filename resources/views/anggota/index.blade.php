...
<div class="card">
    <div class="p-3 border-bottom">
        <div class="d-flex justify-content-between">
            <div class="h3 fw-bold">Data Anggota</div>
            <div class="">
                <a href="{{ route('anggota.create') }}" class="btn btn-dark">
        ...
        <table class="table card-table table-vcenter text-nowrap datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $val->status }}</td>
                    <td>
                        <a href="{{ route('anggota.update', ['kd_anggota' => $val->kd_anggota]) }}" class="btn p-2" style="border: 1px dashed #0c0c0c">
                        ...
                        <a href="{{ route('anggota.delete', ['kd_anggota' => $val->kd_anggota]) }}" class="btn p-2" style="border: 1px dashed #0c0c0c">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon m-0 p-0" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
